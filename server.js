...
routes_1.AppRoutes.forEach(function (route) {
    app.use(route.path, function (request, response, next) {
        route
...
var startServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, app.listen(process.env.PORT || 8080, function () {
                    console.log("Server running on http://127.0.0.1:".concat(process.env.PORT));
                })];
            case 1:
                _a.sent();
                return [2 /*return*/];
